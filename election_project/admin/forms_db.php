      ...
      <nav class="navbar navbar-default" role="navigation">
        ...
        <div class="side-menu-container">
          <ul class="nav navbar-nav">
            <li><a href="../users/home.php"><i class="fa-brands fa-wpforms fa-lg" style="margin-right: 5px;"></i>Registration</a></li>
            ...
            <li><a href="signup.php"><i class="fa-solid fa-user fa-lg" style="margin-right: 5px;"></i></i>Create User</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav>
    </div>
